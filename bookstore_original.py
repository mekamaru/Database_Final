...
#Styling label
font1=('Arial', 15, 'normal')
font1_bold=('Arial', 15, 'bold')
font2=('Arial', 10, 'normal')
font2_bold=('Arial', 10, 'bold')
...
cursor = db.cursor()
cursor.execute("INSERT OR IGNORE into accounts values ('admin', 'adminaccount', '-', '-', 'admin@email.com', 0)")
db.commit()
cursor.close()
...
class loginGUI:
    ...
    #Set the apperance of basic screen
        ...
        self.m_window.geometry("520x300")
        self.m_window.config(bg="#BDEDFF") #Background color

        self.login_window = tkinter.Frame(height = 170, width = 520, bg="#BDEDFF")
        self.creacc_window = tkinter.Frame(height = 170, width = 520, bg="#BDEDFF")
    ...
    #Set the appearance of login window
        self.welcome = tkinter.Label(self.m_window, text="WELCOME", font=font1_bold, fg="#123456", bg="#EBF4FA")
        self.welcome.place(x=200, y=10)

        # Creating a label for User ID
        self.id_label = tkinter.Label(self.m_window, text="User ID:", font=font1_bold, fg="#123456", bg="#EBF4FA")
        self.id_label.place(x=5, y=70)

        # Creating a text entry box for User ID
        self.id_entry = tkinter.Entry(self.m_window, bd=1, font=font1, fg="#000000", bg="white", width=20)
        self.id_entry.place(x=190, y=70)

        # Creating a label for Password
        self.pass_label = tkinter.Label(self.m_window, text="Password:", font=font1_bold, fg="#123456", bg="#EBF4FA")
        self.pass_label.place(x=5, y=100)

        # Creating a text entry box for Password
        self.pass_entry = tkinter.Entry(self.m_window, bd=1, font=font1, fg="#000000", bg="#FFFFFF", show="*", width=20)
        self.pass_entry.place(x=190, y=100)

        # Creating a label for First Name
        self.fname_label = tkinter.Label(self.creacc_window, text="First Name:", font=font1_bold, fg="#123456", bg="#EBF4FA")
        self.fname_label.place(x=5, y=0)
            
        # Creating a text entry box for First Name
        self.fname_entry = tkinter.Entry(self.creacc_window, bd=1, font=font1, fg="#000000", bg="#FFFFFF", width=20)
        self.fname_entry.place(x=190, y=0)

        # Creating a label for Last Name
        self.lname_label = tkinter.Label(self.creacc_window, text="Last Name:", font=font1_bold, fg="#123456", bg="#EBF4FA")
        self.lname_label.place(x=5, y=30)

        # Creating a text entry box for Last Name
        self.lname_entry = tkinter.Entry(self.creacc_window, bd=1, font=font1, fg="#000000", bg="#FFFFFF", width=20)
        self.lname_entry.place(x=190, y=30)
            
        # Creating a label for Email
        self.email_label = tkinter.Label(self.creacc_window, text="Email:", font=font1_bold, fg="#123456", bg="#EBF4FA")
        self.email_label.place(x=5, y=60)
            
        # Creating a text entry box for Email
        self.email_entry = tkinter.Entry(self.creacc_window, bd=1, font=font1, fg="#000000", bg="#FFFFFF", width=20)
        ...
        self.style.configure("TButton", font=font1, foreground="#24344f", background="#FFFFFF", activeforeground="#FFFFFF", activebackground="#24344f")
...
class storemainGUI():
    ...
    #Set the appearance
        ...
        #Geometry string is a standard way of describing the size and location of the window
        # Set the size of the window (x and  y position of the root window)
        self.store_window.geometry("520x300")
        self.store_window.config(bg="#BDEDFF")
    ...
    #Set the detail appearance of buttons
        self.welcome_label = tkinter.Label(self.store_window, text=("Welcome! %s" %self.username), font=font1_bold, fg="#123456", bg="#EBF4FA")
...
class BuyBooksGUI():
    ...
    #Set the appearance
        ...
        # Frame Widgetを 生成
        #frame = tkinter.Frame(canvas,height = 200, width = w, bg = "#EBF4FA") #一覧スクロール　→　メインに直付け・第一フレーム（キャンバス内）
    ...
    #Set the actions
        ...
        def calctotalprice():
            ...
            for i in range(0, len(self.listofbooks)):
                if int(self.numberofbooks[i].get()) > self.listofbooks[i][5]:
                    ...
                    self.total_head = tkinter.Label(self.selectbook_window_bot, text=("Subtotal(" + str(self.qtytotal) + " books): $" + str(round(self.subtotal, 2))), font=font1_bold, fg="#123456", bg="#EBF4FA")
        ...
        def createbookslist(conn):
            ...
            self.priceofbooks = []
            self.numberofbooks = []
            self.bookcatalogue = tkinter.Frame(self.canvas,height = 200, width = w, bg = "#EBF4FA")
            ...
            title_head = tkinter.Label(self.bookcatalogue, text= "Title", font=font2, fg="#123456", bg="#EBF4FA")
            title_head.grid(row = 0, column = 1)
            author_head = tkinter.Label(self.bookcatalogue, text= "Author", font=font2, fg="#123456", bg="#EBF4FA")
            author_head.grid(row = 0, column = 2)
            publisher_head = tkinter.Label(self.bookcatalogue, text= "Publisher", font=font2, fg="#123456", bg="#EBF4FA")
            publisher_head.grid(row = 0, column = 3)
            price_head = tkinter.Label(self.bookcatalogue, text= "Price", font=font2, fg="#123456", bg="#EBF4FA")
            price_head.grid(row = 0, column = 4)
            available_head = tkinter.Label(self.bookcatalogue, text= "Availablity", font=font2, fg="#123456", bg="#EBF4FA")
            available_head.grid(row = 0, column = 5)
            qty_head = tkinter.Label(self.bookcatalogue, text= "Qty", font=font2, fg="#123456", bg="#EBF4FA")
            qty_head.grid(row = 0, column = 6)
            
            for bk in selectedbooks:
                self.listofbooks.append(bk)
                var = tkinter.DoubleVar()
                title = tkinter.Label(self.bookcatalogue, text= str(bk[1]), font=font2, fg="#123456", bg="#EBF4FA")
                author = tkinter.Label(self.bookcatalogue, text= str(bk[2]), font=font2, fg="#123456", bg="#EBF4FA")
                publisher = tkinter.Label(self.bookcatalogue, text= str(bk[3]), font=font2, fg="#123456", bg="#EBF4FA")
                price = tkinter.Label(self.bookcatalogue, text= ("$" + str(bk[4])), font=font2, fg="#123456", bg="#EBF4FA")
                available = tkinter.Label(self.bookcatalogue, text= str(bk[5]), font=font2, fg="#123456", bg="#EBF4FA")
                unavailable = tkinter.Label(self.bookcatalogue, text= "Unavailable", font=font2, fg="#123456", bg="#EBF4FA")
        ...
        def cartreset():
            ...
            self.total_head = tkinter.Label(self.selectbook_window_bot, text=("Subtotal(" + str(self.qtytotal) + " books): $" + str(self.subtotal)),
                                            font=font1_bold, fg="#123456", bg="#EBF4FA")
            self.total_head.place(x=300, y=10)
            createbookslist(self.cursor.execute('SELECT * FROM books'))
        ...
        def selectpayment():
            ...
            def gotopay():
                self.pay_method = tkinter.Label(self.purchase_window_bot, text=self.method, font=font2, fg="#123456", bg="#EBF4FA")
            ...
            def card():
                ...
                self.card_selectpay_head = tkinter.Label(self.method_window_card, text="Card Information", font=font1_bold, fg="#123456", bg="#EBF4FA")
                self.card_selectpay_head.place(x=350, y=5)

                self.cardinfo_head = tkinter.Label(self.method_window_card, text="Card Detail:", font=font2_bold, fg="#123456", bg="#EBF4FA")
                self.cardname_label = tkinter.Label(self.method_window_card, text="Name on Card:", font=font2, fg="#123456", bg="#EBF4FA")
                self.cardname_entry = tkinter.Entry(self.method_window_card, bd=1, font=font2, fg="#000000", bg="white", width=30)
                self.cardnumber_label = tkinter.Label(self.method_window_card, text="Card Number:", font=font2, fg="#123456", bg="#EBF4FA")
                self.nospace = tkinter.Label(self.method_window_card, text = "(no space)", font=font2, fg="#123456", bg="#EBF4FA")
                self.cardnumber_entry = tkinter.Entry(self.method_window_card, bd=1, font=font2, fg="#000000", bg="white", width=30)
                self.cardexp_label = tkinter.Label(self.method_window_card, text="Expire MM/YY:", font=font2, fg="#123456", bg="#EBF4FA")
                self.cardexpmon_entry = tkinter.Entry(self.method_window_card, bd=1, font=font2, fg="#000000", bg="white", width=3)
                self.cardexpto_label = tkinter.Label(self.method_window_card, text="/", font=font2, fg="#123456", bg=self.bgcolor2)
                self.cardexpyear_entry = tkinter.Entry(self.method_window_card, bd=1, font=font2, fg="#000000", bg="white", width=3)
                self.cardcvc_label = tkinter.Label(self.method_window_card, text="CVC:", font=font2, fg="#123456", bg="#EBF4FA")
                self.cardcvc_entry = tkinter.Entry(self.method_window_card, bd=1, font=font2, show = "*", fg="#000000", bg="white", width=5)
                self.cardphone_label = tkinter.Label(self.method_window_card, text="Phone:", font=font2, fg="#123456", bg="#EBF4FA")
                self.cardphone_entry = tkinter.Entry(self.method_window_card, bd=1, font=font2, fg="#000000", bg="white", width=30)

                
                
                
                self.bill_head = tkinter.Label(self.method_window_card, text="Billing Address:", font=font2_bold, fg="#123456", bg="#EBF4FA")
                self.bill_street_label = tkinter.Label(self.method_window_card, text="Street:", font=font2, fg="#123456", bg="#EBF4FA")
                self.bill_street_entry = tkinter.Entry(self.method_window_card, bd=1, font=font2, fg="#000000", bg="white", width=35)
                self.bill_city_label = tkinter.Label(self.method_window_card, text="City:", font=font2, fg="#123456", bg="#EBF4FA")
                self.bill_city_entry = tkinter.Entry(self.method_window_card, bd=1, font=font2, fg="#000000", bg="white", width=35)
                self.bill_state_label = tkinter.Label(self.method_window_card, text="State:", font=font2, fg="#123456", bg="#EBF4FA")
                self.bill_state_entry = tkinter.Entry(self.method_window_card, bd=1, font=font2, fg="#000000", bg="white", width=35)
                self.bill_country_label = tkinter.Label(self.method_window_card, text="Country:", font=font2, fg="#123456", bg="#EBF4FA")
                self.bill_country_entry = tkinter.Entry(self.method_window_card, bd=1, font=font2, fg="#000000", bg="white", width=35)
                self.bill_zip_label = tkinter.Label(self.method_window_card, text="Zipcode:", font=font2, fg="#123456", bg="#EBF4FA")
                self.bill_zip_entry = tkinter.Entry(self.method_window_card, bd=1, font=font2, fg="#000000", bg="white", width=35)
                self.card_savemethod_button = tkinter.Checkbutton(self.method_window_card, text = "Save this method for next purchase?",
                                                             variable = self.savecheck, onvalue = 1, offvalue = 0, font = font2, bg = self.bgcolor2)
            ...
            def bank():
                ...
                self.bank_selectpay_head = tkinter.Label(self.method_window_bank, text="Bank Information", font=font1_bold, fg="#123456", bg="#EBF4FA")
                self.bank_selectpay_head.place(x=350, y=5)

                self.bankinfo_head = tkinter.Label(self.method_window_bank, text="Bank Detail:", font=font2_bold, fg="#123456", bg="#EBF4FA")
                self.bankname_label = tkinter.Label(self.method_window_bank, text="Bank Name:", font=font2, fg="#123456", bg="#EBF4FA")
                self.bankname_entry = tkinter.Entry(self.method_window_bank, bd=1, font=font2, fg="#000000", bg="white", width=30)
                self.banktype = tkinter.StringVar(value="None")
                self.banktype_label = tkinter.Label(self.method_window_bank, text="Account Type:", font=font2, fg="#123456", bg="#EBF4FA")
                self.banktype_entry = tkinter.OptionMenu(self.method_window_bank, self.banktype, "Checking", "Saving" )
                self.routing_label = tkinter.Label(self.method_window_bank, text="Routing Number:", font=font2, fg="#123456", bg="#EBF4FA")
                self.routing_entry = tkinter.Entry(self.method_window_bank, bd=1, font=font2, fg="#000000", bg="white", width=30)
                self.bankacc_label = tkinter.Label(self.method_window_bank, text="Account Number:", font=font2, fg="#123456", bg="#EBF4FA")
                self.bankacc_entry = tkinter.Entry(self.method_window_bank, bd=1, font=font2, fg="#000000", bg="white", width=30)

                self.bank_savemethod_button = tkinter.Checkbutton(self.method_window_bank, text = "Save this method for next purchase?",
                                                             variable = self.savecheck, onvalue = 2, offvalue = 0, font = font2, bg = self.bgcolor2)
                ...
                self.banktype_entry.config(font = font2)
            ...
            def cash():
                ...
                self.cash_head = tkinter.Label(self.method_window_cash, text="You must pay when you receive the box.", font=font1_bold, fg="#123456", bg="#EBF4FA")
                ...
                self.cash_savemethod_button = tkinter.Checkbutton(self.method_window_cash, text = "Save this method for next purchase?",
                                                             variable = self.savecheck, onvalue = 3, offvalue = 0, font = font2, bg = self.bgcolor2)
            ...
            self.selectpay_head = tkinter.Label(self.method_window_main, text="Select Payment Method", font=font1_bold, fg="#123456", bg="#EBF4FA")
        ...
        def viewsummary():
            ...
            self.summary_head = tkinter.Label(self.purchase_window_top, text="Order Summary", font=font1_bold, fg="#123456", bg="#EBF4FA")
            self.summary_head.place(x=340, y=0)
            self.bkcatalogue_summary = tkinter.Frame(self.canvas,height = 180, width = w, bg = "#EBF4FA")
            self.canvas.create_window((0,0), window=self.bkcatalogue_summary, anchor=tkinter.NW, width=self.canvas.cget('width'))

            title_head = tkinter.Label(self.bkcatalogue_summary, text= "Title", font=font2, fg="#123456", bg="#EBF4FA")
            title_head.grid(row = 0, column = 1)
            author_head = tkinter.Label(self.bkcatalogue_summary, text= "Author", font=font2, fg="#123456", bg="#EBF4FA")
            author_head.grid(row = 0, column = 2)
            publisher_head = tkinter.Label(self.bkcatalogue_summary, text= "Publisher", font=font2, fg="#123456", bg="#EBF4FA")
            publisher_head.grid(row = 0, column = 3)
            price_head = tkinter.Label(self.bkcatalogue_summary, text= "Price", font=font2, fg="#123456", bg="#EBF4FA")
            price_head.grid(row = 0, column = 4)
            qty_head = tkinter.Label(self.bkcatalogue_summary, text= "Qty", font=font2, fg="#123456", bg="#EBF4FA")
            ...
            for i in range(0, len(self.orderbooks)):
                ...
                if bid != 0:
                    ...
                    title = tkinter.Label(self.bkcatalogue_summary, text= str(book[1]), font=font2, fg="#123456", bg="#EBF4FA")
                    author = tkinter.Label(self.bkcatalogue_summary, text= str(book[2]), font=font2, fg="#123456", bg="#EBF4FA")
                    publisher = tkinter.Label(self.bkcatalogue_summary, text= str(book[3]), font=font2, fg="#123456", bg="#EBF4FA")
                    price = tkinter.Label(self.bkcatalogue_summary, text= ("$" + str(book[4])), font=font2, fg="#123456", bg="#EBF4FA")
                    qty = tkinter.Label(self.bkcatalogue_summary, text= str(self.orderbooks[i]), font=font2, fg="#123456", bg="#EBF4FA")
            ...
            self.total_head_summary = tkinter.Label(self.purchase_window_bot, text=("Subtotal(" + str(self.qtytotal) + " books): $" + str(round(self.subtotal, 2))),
                                            font=font1, fg="#123456", bg="#EBF4FA")
            ...
            self.ship_head = tkinter.Label(self.purchase_window_bot, text="Shipping Address:", font=font2_bold, fg="#123456", bg="#EBF4FA")
            self.ship_name_label = tkinter.Label(self.purchase_window_bot, text="Full Name:", font=font2, fg="#123456", bg="#EBF4FA")
            self.ship_name_entry = tkinter.Entry(self.purchase_window_bot, bd=1, font=font2, fg="#000000", bg="white", width=35)
            self.ship_street_label = tkinter.Label(self.purchase_window_bot, text="Street:", font=font2, fg="#123456", bg="#EBF4FA")
            self.ship_street_entry = tkinter.Entry(self.purchase_window_bot, bd=1, font=font2, fg="#000000", bg="white", width=35)
            self.ship_city_label = tkinter.Label(self.purchase_window_bot, text="City:", font=font2, fg="#123456", bg="#EBF4FA")
            self.ship_city_entry = tkinter.Entry(self.purchase_window_bot, bd=1, font=font2, fg="#000000", bg="white", width=35)
            self.ship_state_label = tkinter.Label(self.purchase_window_bot, text="State:", font=font2, fg="#123456", bg="#EBF4FA")
            self.ship_state_entry = tkinter.Entry(self.purchase_window_bot, bd=1, font=font2, fg="#000000", bg="white", width=35)
            self.ship_country_label = tkinter.Label(self.purchase_window_bot, text="Country:", font=font2, fg="#123456", bg="#EBF4FA")
            self.ship_country_entry = tkinter.Entry(self.purchase_window_bot, bd=1, font=font2, fg="#000000", bg="white", width=35)
            self.ship_zip_label = tkinter.Label(self.purchase_window_bot, text="Zipcode:", font=font2, fg="#123456", bg="#EBF4FA")
            self.ship_zip_entry = tkinter.Entry(self.purchase_window_bot, bd=1, font=font2, fg="#000000", bg="white", width=35)
            ...
            self.subandtax = tkinter.Label(self.purchase_window_bot, text=("Subtotal: $" + str(round(self.subtotal, 2)) +
                                                                           "\nTax: $" + str(round(self.subtotal * 0.0625))), font=font1, fg="#123456", bg="#EBF4FA")
            self.taxtotal = tkinter.Label(self.purchase_window_bot, text=("    Total: $" + str(round(self.subtotal, 2)+round(self.subtotal * 0.0625))), font=font1_bold, fg="#123456", bg="#EBF4FA")
            self.subandtax.place(x=500, y=70)
            self.taxtotal.place(x=500, y=130)

            self.pay_head = tkinter.Label(self.purchase_window_bot, text="Payment Method:", font=font2_bold, fg="#123456", bg="#EBF4FA")
            ...
            self.confirm_button = ttk.Button(self.purchase_window_bot, command=checkout, text="Place Your Order", style="font1.TButton", width=20)
        ...
        self.bookcatalogue_label = tkinter.Label(self.selectbook_window_mid, text="Book Catalogue", font=font1_bold, fg="#123456", bg="#EBF4FA")
        self.bookcatalogue_label.place(x=340, y=90)
        self.title_label = tkinter.Label(self.selectbook_window_mid, text="Title=", font=font2, fg="#123456", bg="#EBF4FA")
        self.title_entry = tkinter.Entry(self.selectbook_window_mid, bd=1, font=font2, fg="#000000", bg="white", width=30)
        self.author_label = tkinter.Label(self.selectbook_window_mid, text="Author=", font=font2, fg="#123456", bg="#EBF4FA")
        self.author_entry = tkinter.Entry(self.selectbook_window_mid, bd=1, font=font2, fg="#000000", bg="white", width=30)
        self.publisher_label = tkinter.Label(self.selectbook_window_mid, text="Publisher=", font=font2, fg="#123456", bg="#EBF4FA")
        self.publisher_entry = tkinter.Entry(self.selectbook_window_mid, bd=1, font=font2, fg="#000000", bg="white", width=30)
        self.price_label = tkinter.Label(self.selectbook_window_mid, text="Price=", font=font2, fg="#123456", bg="#EBF4FA")
        self.price_to = tkinter.Label(self.selectbook_window_mid, text="=<=", font=font2, fg="#123456", bg="#EBF4FA")
        self.price_min_entry = tkinter.Entry(self.selectbook_window_mid, bd=1, font=font2, fg="#000000", bg="white", width=10)
        self.price_max_entry = tkinter.Entry(self.selectbook_window_mid, bd=1, font=font2, fg="#000000", bg="white", width=10)
        self.available_label = tkinter.Label(self.selectbook_window_mid, text="Available=", font=font2, fg="#123456", bg="#EBF4FA")
        self.available_to = tkinter.Label(self.selectbook_window_mid, text="=<=", font=font2, fg="#123456", bg="#EBF4FA")
        self.available_min_entry = tkinter.Entry(self.selectbook_window_mid, bd=1, font=font2, fg="#000000", bg="white", width=10)
        self.available_max_entry = tkinter.Entry(self.selectbook_window_mid, bd=1, font=font2, fg="#000000", bg="white", width=10)
        ...
        self.total_head = tkinter.Label(self.selectbook_window_bot, text=("Subtotal(" + str(self.qtytotal) + " books): $" + str(self.subtotal)), font=font1_bold, fg="#123456", bg="#EBF4FA")
        self.total_head.place(x=270, y=10)
        self.vieworder_button = ttk.Button(self.selectbook_window_bot, command=viewsummary, text="Proceed to Checkout", style="font1.TButton", width=20)
        ...
        self.style = ttk.Style()
        self.style.configure("TButton", font=font2, foreground="#24344f", background="#FFFFFF", activeforeground="#FFFFFF", activebackground="#24344f")
        self.style.configure("font1.TButton", font=font1, foreground="#24344f", background="#FFFFFF", activeforeground="#FFFFFF", activebackground="#24344f")
...
class UserInfoGUI():
    ...
    #Set the appearance
        ...
        #Geometry string is a standard way of describing the size and location of the window
        # Set the size of the window (x and  y position of the root window)
        self.userinfo_window.geometry("520x300")
        self.userinfo_window.config(bg="#BDEDFF") #Background color
    ...
    #Set the detail appearance    
        self.userinfo_head = tkinter.Label(self.userinfo_window, text="User Info Update", font=font1_bold, fg="#123456", bg="#EBF4FA")

        # Creating a label for Password
        self.pass_label = tkinter.Label(self.userinfo_window, text="Password:", font=font1_bold, fg="#123456", bg="#EBF4FA")

        # Creating a text entry box for Password
        self.pass_entry = tkinter.Entry(self.userinfo_window, bd=1, font=font1, fg="#000000", bg="#FFFFFF", width=20)

        # Creating a label for First Name
        self.fname_label = tkinter.Label(self.userinfo_window, text="First Name:", font=font1_bold, fg="#123456", bg="#EBF4FA")

        # Creating a text entry box for First Name
        self.fname_entry = tkinter.Entry(self.userinfo_window, bd=1, font=font1, fg="#000000", bg="#FFFFFF", width=20)

        # Creating a label for Last Name
        self.lname_label = tkinter.Label(self.userinfo_window, text="Last Name:", font=font1_bold, fg="#123456", bg="#EBF4FA")

        # Creating a text entry box for Last Name
        self.lname_entry = tkinter.Entry(self.userinfo_window, bd=1, font=font1, fg="#000000", bg="#FFFFFF", width=20)
            
        # Creating a label for Email
        self.email_label = tkinter.Label(self.userinfo_window, text="Email:", font=font1_bold, fg="#123456", bg="#EBF4FA")
            
        # Creating a text entry box for Email
        self.email_entry = tkinter.Entry(self.userinfo_window, bd=1, font=font1, fg="#000000", bg="#FFFFFF", width=20)
...
class adminGUI():
    ...
    #Set the appearance
        ...
        #Geometry string is a standard way of describing the size and location of the window
        # Set the size of the window (x and  y position of the root window)
        self.admin_window.geometry("520x300")
        self.admin_window.config(bg="#BDEDFF") #Background color
    ...
    #Set the actions
        ...
        #Creating buttons
        self.adminhead = tkinter.Label(self.admin_window, text="Admin Panel", font=font1, fg="#123456", bg="#EBF4FA")
        ...
        self.style = ttk.Style()
        self.style.configure("TButton", font=font1, foreground="#24344f", background="#FFFFFF", activeforeground="#FFFFFF", activebackground="#24344f")
        self.style.configure("logout.TButton", font=font1, foreground="#C32148", background="#FFFFFF", activeforeground="#FFFFFF", activebackground="#24344f")
...
class UserManageGUI():
    ...
    #Set the actions
        ...
        def placelines(com,tex):
            ...
            if flag == True:
                self.saved_payment_label.place(x=5, y=180)
                self.saved_payment_entry.place(x=200, y=180)
                ...
                self.cancel_button.place(x=150, y=250)
    ...
    #Set the appearance
        ...
        self.acc_window.geometry("520x300")
        self.acc_window.config(bg="#BDEDFF") #Background color
        
        # Creating a label for User ID
        self.userid_label = tkinter.Label(self.acc_window, text="User ID:", font=font1_bold, fg="#123456", bg="#EBF4FA")

        # Creating a text entry box for User ID
        self.userid_entry = tkinter.Entry(self.acc_window, bd=1, font=font1, fg="#000000", bg="white", width=20)

        # Creating a label for Password
        self.pass_label = tkinter.Label(self.acc_window, text="Password:", font=font1_bold, fg="#123456", bg="#EBF4FA")

        # Creating a text entry box for Password
        self.pass_entry = tkinter.Entry(self.acc_window, bd=1, font=font1, fg="#000000", bg="#FFFFFF", width=20)
        
        # Creating a label for First Name
        self.fname_label = tkinter.Label(self.acc_window, text="First Name:", font=font1_bold, fg="#123456", bg="#EBF4FA")

        # Creating a text entry box for First Name
        self.fname_entry = tkinter.Entry(self.acc_window, bd=1, font=font1, fg="#000000", bg="#FFFFFF", width=20)

        # Creating a label for Last Name
        self.lname_label = tkinter.Label(self.acc_window, text="Last Name:", font=font1_bold, fg="#123456", bg="#EBF4FA")

        # Creating a text entry box for Last Name
        self.lname_entry = tkinter.Entry(self.acc_window, bd=1, font=font1, fg="#000000", bg="#FFFFFF", width=20)
            
        # Creating a label for Email
        self.email_label = tkinter.Label(self.acc_window, text="Email:", font=font1_bold, fg="#123456", bg="#EBF4FA")
            
        # Creating a text entry box for Email
        self.email_entry = tkinter.Entry(self.acc_window, bd=1, font=font1, fg="#000000", bg="#FFFFFF", width=20)

        # Creating a label for Payment Method
        self.saved_payment_label = tkinter.Label(self.acc_window, text="Payment method:", font=font1_bold, fg="#123456", bg="#EBF4FA")
            
        # Creating a text entry box for Payment Method
        self.saved_payment_entry = tkinter.Entry(self.acc_window, bd=1, font=font1, fg="#000000", bg="#FFFFFF", width=20)
        ...
        if flag == True: #edit user
            ...
            canvas = tkinter.Canvas(self.acc_window, bg ="#BDEDFF", height = 150, width= 500)

           # Scrollbar を生成して配置
            bar = tkinter.Scrollbar(self.acc_window, orient=tkinter.VERTICAL)
            bar.pack(side=tkinter.RIGHT, ipady = 100)
            ...
            for bk in accs:
                ids.append(bk[0])
                txt = ("UserID: %s"%str(bk[0]) + "/ Password: %s"%str(bk[1]) + "\nFirstname: %s"%str(bk[2]) + "/ Lastname: %s"%str(bk[3]) + "\nEmail: %s"%str(bk[4]) + "/ Payment method: %s"%str(bk[5]))
                bt = tkinter.Radiobutton(frame, text=txt, bg ="#BDEDFF", variable = var, value = ind, command=set_userid)
                ind = ind + 1
                bt.pack(fill=tkinter.X)

            canvas.pack(side=tkinter.TOP, pady= 50)

            self.chooseone = tkinter.Label(self.acc_window, text = "Choose an account for edit", font=font1_bold, fg="#123456", bg="#EBF4FA")
            self.chooseone.place(x=130, y=10)
            self.cancel_button.place(x=150, y=220)
...
class BookManageGUI():
    ...
    #Set the actions
        ...
        def placelines(com,tex):
            ...
            if flag == True:
                ...
                self.cancel_button.place(x=150, y=230)

            else: self.cancel_button.place(x=260, y=190)
    ...
    #Set the appearance
        ...
        self.book_window.geometry("520x300")
        self.book_window.config(bg="#BDEDFF") #Background color

        # Creating a label and entry box for Title
        self.title_label = tkinter.Label(self.book_window, text="Title:", font=font1_bold, fg="#123456", bg="#EBF4FA")
        self.title_entry = tkinter.Entry(self.book_window, bd=1, font=font1, fg="#000000", bg="white", width=30)
        
        # Creating a label and entry box for Author
        self.author_label = tkinter.Label(self.book_window, text="Author:", font=font1_bold, fg="#123456", bg="#EBF4FA")
        self.author_entry = tkinter.Entry(self.book_window, bd=1, font=font1, fg="#000000", bg="white", width=30)    

        # Creating a label and entry box for Publisher
        self.publisher_label = tkinter.Label(self.book_window, text="Publisher:", font=font1_bold, fg="#123456", bg="#EBF4FA")
        self.publisher_entry = tkinter.Entry(self.book_window, bd=1, font=font1, fg="#000000", bg="white", width=30)

        # Creating a label and entry box for Price
        self.price_label = tkinter.Label(self.book_window, text="Price:      $", font=font1_bold, fg="#123456", bg="#EBF4FA")
        self.price_entry = tkinter.Entry(self.book_window, bd=1, font=font1, fg="#000000", bg="white", width=20)

        # Creating a label and entry box for Available
        self.available_label = tkinter.Label(self.book_window, text="Available:", font=font1_bold, fg="#123456", bg="#EBF4FA")
        self.available_entry = tkinter.Spinbox(self.book_window, from_=0, to = 2147483647, bd=1, font=font1, fg="#000000", bg="white", width=20)
        ...
        if flag == True: #edit book
            ...
            canvas = tkinter.Canvas(self.book_window, bg ="#BDEDFF", height = 150, width= 500)

           # Scrollbar を生成して配置
            bar = tkinter.Scrollbar(self.book_window, orient=tkinter.VERTICAL)
            bar.pack(side=tkinter.RIGHT, ipady = 60)
            bar.config(command=canvas.yview)

            canvas.config(yscrollcommand=bar.set)
            canvas.config(scrollregion=(0,0,0,500)) #スクロール範囲
            #fill=tkinter.BOTH
            ...
            canvas.config(scrollregion=(0,0,50,len(bks)*40))
            var = tkinter.IntVar()
            ids =[]
            ind = 0
            for bk in bks:
                ids.append(bk[0])
                txt = ("BookID: %s"%str(bk[0]) + "/ Title: %s"%str(bk[1]) + "/ Author: %s"%str(bk[2]) + "\nPublisher: %s"%str(bk[3]) + "/ Price: %s"%str(bk[4]) + "/ Availability: %s"%str(bk[5]))
                bt = tkinter.Radiobutton(frame, text=txt, bg ="#BDEDFF", variable = var, value = ind, command=set_bookid)
                ind = ind + 1
                bt.pack(fill=tkinter.X)

            canvas.pack(side=tkinter.TOP, pady= 50)

            self.chooseone = tkinter.Label(self.book_window, text = "Choose a book for edit", font=font1_bold, fg="#123456", bg="#EBF4FA")
            self.chooseone.place(x=150, y=10)
            self.cancel_button.place(x=150, y=220)
    ...
    #Set the actions
        ...
        def createorderslist(conn):
            def viewdetail():
                ...
                self.vieworder_detail = tkinter.Frame(self.canvas, height=460, width = 820, bg = "#EBF4FA")
                ...
                info = tkinter.Label(self.vieworder_detail, text= txt, font=font2, fg="#123456", bg="#EBF4FA")
                info.place(x=0,y=0)
            ...
            self.orderlist = tkinter.Frame(self.canvas,height = 460, width = w, bg = "#EBF4FA")
            ...
            oid_head = tkinter.Label(self.orderlist, text= "order ID", font=font2, fg="#123456", bg="#EBF4FA")
            oid_head.grid(row = 0, column = 1)
            uid_head = tkinter.Label(self.orderlist, text= "user ID", font=font2, fg="#123456", bg="#EBF4FA")
            uid_head.grid(row = 0, column = 2)
            qty_head = tkinter.Label(self.orderlist, text= "Total Qty", font=font2, fg="#123456", bg="#EBF4FA")
            qty_head.grid(row = 0, column = 3)
            price_head = tkinter.Label(self.orderlist, text= "Total Price", font=font2, fg="#123456", bg="#EBF4FA")
            price_head.grid(row = 0, column = 4)
            method_head = tkinter.Label(self.orderlist, text= "Payment Method", font=font2, fg="#123456", bg="#EBF4FA")
            method_head.grid(row = 0, column = 5)
            detail_head = tkinter.Label(self.orderlist, text= "Show Detail", font=font2, fg="#123456", bg="#EBF4FA")
            detail_head.grid(row = 0, column = 6)
            
            for order in self.selectedorders:
                print(str(order[0]))
                oid = tkinter.Label(self.orderlist, text= str(order[0]), font=font2, fg="#123456", bg="#EBF4FA")
                uid = tkinter.Label(self.orderlist, text= str(order[1]), font=font2, fg="#123456", bg="#EBF4FA")
                qty = tkinter.Label(self.orderlist, text= str(sum([int(x) for x in order[2].split(":")])), font=font2, fg="#123456", bg="#EBF4FA")
                price = tkinter.Label(self.orderlist, text= ("$" +str(order[3])), font=font2, fg="#123456", bg="#EBF4FA")
                method = tkinter.Label(self.orderlist, text= str(order[5].split(":")[0]), font=font2, fg="#123456", bg="#EBF4FA")
                print(order[5])
                detail = tkinter.Radiobutton(self.orderlist, variable=self.var, value=int(order[0]), command = viewdetail, fg="#123456", bg="#EBF4FA")
                detail.deselect()
            ...
            self.vieworder_head = tkinter.Label(self.vieworder_window_top, text= "View Order", font=font1_bold, fg="#123456", bg="#EBF4FA")
